...
MODEL_NAME = PATHS.get_model_detection_dir_path()
...
PATH_TO_FROZEN_GRAPH = PATHS.get_model_frozen_graph_path()
# PATH_TO_LABELS='../object_detection/data/mscoco_label_map.pbtxt'
PATH_TO_LABELS = PATHS.get_model_detection_label_path()
...
def arg_parse():
    ...
    parser.add_argument('--forzen_graph',
                        type=str,
                        help='The path of detection frozen graph is used')
...
if __name__ == '__main__':
    ...
    run_inference_for_images_per_image(graph, image_dataset_path,
                                       np_paths_boxes_path, 0.5)
